  ...
  return (
    <>
      ...
      <div className={'static h-screen'}>
        ...
        <div ref={actionButtonRef} className={'bottom-2 right-2 z-10 flex space-y-2 md:bottom-5 md:right-5 print:hidden' + (showSettingsAtBottom ? ' mx-2 justify-end' : ' fixed flex-col' )}>
